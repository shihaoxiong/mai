...
1. `P2-03` Implement `McpConfigService`.
2. `P2-04` Implement `SkillRegistryService`.
3. `P2-05` Implement `UploadService`.
4. `P2-06` Implement document-to-Markdown conversion.
5. `P2-07` Implement `ArtifactService`.
