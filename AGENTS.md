...
1. `P1-08` Add minimal runtime verification coverage.
2. `P2-01` Implement `RuntimeConfigRepository`.
3. `P2-02` Implement `ModelRegistryService`.
4. `P2-03` Implement `McpConfigService`.
5. `P2-04` Implement `SkillRegistryService`.
